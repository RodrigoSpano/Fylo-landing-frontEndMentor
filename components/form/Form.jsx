  ...
  return (
    ...
    <Stack alignItems='center' justifyContent='center' zIndex='1' pt={5} userSelect='none'>
      <motion.div initial={{y:40}}>
        ...
        <Stack bg='hsl(217, 28%, 15%)' h={{base:'sm',sm:'2xs'}} borderRadius={10} boxShadow='0px 0px 22px -3px rgba(0,0,0,0.5)' w={{base:'sm',sm:'container.sm'}} p={10}>

          <Flex direction='column' alignItems='center' gap={5}>
            <Heading fontFamily='Raleway, sans-serif' as='h2' fontSize={{base:'20px',sm:'26px'}}>Get early access today</Heading>
